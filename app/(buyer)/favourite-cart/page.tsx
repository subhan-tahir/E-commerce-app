...
import { addToCart, removeCart, removeFromWishlist } from "@/app/features/cartSlice";
...
const WhishListPage = () => {
    ...
    const handleRemoveFromCart = (itemId: number) => {
        dispatch(removeCart(itemId as any));
    }
    if (loading) {
        return (
    ...
    return (
        <Container className="space-y-16 pb-16 max-w-[80rem]">
            <h2 className="text-2xl font-semibold mb-4 text-center">Favourite Cart</h2>
