...
export const metadata: Metadata = {
  ...
  keywords: ['E-store', 'ecommerce', 'buy', 'sell', 'online shopping','my ecommerce','ecommerce app','ecommerce website','ecommerce platform','online store','buy online','sell online'],
